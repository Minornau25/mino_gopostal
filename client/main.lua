    ...
    while true do
		...
		if ESX ~= nil then
			...
			if PlayerJobInfo ~= nil then
				if PlayerJobInfo.name == "gopostal" then
        			local playerPed = PlayerPedId()
					local coords = GetEntityCoords(playerPed)
					local distance3 = GetDistanceBetweenCoords(coords, Config.Coords.service.X, Config.Coords.service.Y, Config.Coords.service.Z, true)
